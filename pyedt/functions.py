...
def single_pass_erosion_x(array, closed_border, scale=False):
    """
    Inplace operation
    """
    w, h, d = array.shape
...
@njit(parallel=True, cache=True)
def single_pass_erosion_y(array, closed_border, scale=False):
    """
    Inplace operation
    """
    w, h, d = array.shape
...
@njit(parallel=True, cache=True)
def single_pass_erosion_z(array, closed_border, scale=False, sqrt_result=False):
    """
    Inplace operation
    """
    w, h, d = array.shape
